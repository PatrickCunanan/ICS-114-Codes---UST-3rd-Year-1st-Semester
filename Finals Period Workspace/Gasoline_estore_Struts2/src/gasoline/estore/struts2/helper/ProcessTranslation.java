package gasoline.estore.struts2.helper;

import java.util.regex.Pattern;

public class ProcessTranslation {
	private String[] first =  {"isa","dalawa","tatlo","apat","lima","anim","pito","walo","siyam"};
	private String[] second = {" labing"," dalawampu't "," tatlumpu't "," apatnapu't "," limampu't "," animnapu't "," pitumpu't "," walumpu't "," siyamnapu't "};
	private String[] third = {" sampu "," dalawampu "," tatlumpu "," apatnapu "," limampu "," animnapu "," pitumpu "," walumpu "," siyamnapu "};
	private String[] fourth = {"isang ","dalawang ","tatlong ","apat na ","limang ","anim na ","pitong ","walong ","siyam na "};
	private String[] fifth = {"daan ","libo","pung libo"};
	private String message = "";
	private boolean a4,b4,c4,d4;
	public  String translate(double total){
